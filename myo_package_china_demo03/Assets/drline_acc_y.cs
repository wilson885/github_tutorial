...
public class drline_acc_y : MonoBehaviour
{
...
//        _line.SetPosition(50, new Vector3(startpoint.transform.position.x + 500, startpoint.transform.position.y, 0));
    ...
    public void record()
    {
        ...
        _line.SetPosition(i, new Vector3(forward + startpoint.transform.position.x, _data * wavestrength  + startpoint.transform.position.y, 1000));
