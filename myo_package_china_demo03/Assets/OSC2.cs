...
public delegate void OscMessageHandler2(OscMessage oscM);
...
/// 
/// </summary>
public class Osc2 : MonoBehaviour
{

    /// <summary>
    /// Osc Constructor.  Starts the Reader thread and initializes some internal state.
    /// </summary>
    /// <param name="oscPacketIO2">The PacketIO instance used for packet IO.</param>
    /*
	...
	*/
    ...
    public void init(UDPPacketIO2 oscPacketIO)
    {
        OscPacketIO = oscPacketIO;
    ...
    /// </summary>
    /// <param name="oscMessage2">The OSC Message to send.</param>   
    ...
    private UDPPacketIO2 OscPacketIO;
    Thread ReadThread;
